...
<div class="container-fluid">
    <div class="row mb-3">
        <div class="col-md-6">
            <h1><i class="fas fa-users-class"></i> Editar Grupo</h1>
        </div>
        <div class="col-md-6 text-end">
            <a href="index.php" class="btn btn-secondary">
                <i class="fas fa-arrow-left"></i> Volver al Listado
            </a>
            <a href="ver.php?id=<?= $id_grupo ?>" class="btn btn-info">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form id="form-grupo" action="actualizar.php" method="post" class="needs-validation" novalidate>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="turno" name="turno" required>
                                        ...
                                        <option value="<?= $id ?>" <?= ($grupo['id_turno'] == $id) ? 'selected' : '' ?>>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="grado" name="grado" required>
                                        ...
                                        <option value="<?= $id ?>" <?= ($grupo['id_grado'] == $id) ? 'selected' : '' ?>>
                                            <?= htmlspecialchars($nombre) ?>
                                        </option>
                                        <?php endforeach; ?>
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nombre_grupo" name="nombre_grupo" required maxlength="10" value="<?= htmlspecialchars($grupo['nombre_grupo']) ?>">
                                    <div class="invalid-feedback">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="ciclo_escolar" name="ciclo_escolar" required maxlength="20" value="<?= htmlspecialchars($grupo['ciclo_escolar']) ?>">
                                    <div class="invalid-feedback">
                                        Por favor ingrese el ciclo escolar
                                    </div>
                                    <div class="form-text">
                                        Formato: AAAA-AAAA (ejemplo: 2024-2025)
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="color" class="form-control form-control-color" id="color_credencial" name="color_credencial" value="<?= htmlspecialchars($grupo['color_credencial']) ?>" required>
                                        <input type="text" class="form-control" id="color_hex" value="<?= htmlspecialchars($grupo['color_credencial']) ?>" readonly>
                                    </div>
                                    <div class="invalid-feedback">
                                ...
                                <div class="mb-3">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div id="preview-credencial" class="border p-3" style="background-color: <?= htmlspecialchars($grupo['color_credencial']) ?>; border-radius: 8px;">
                                                ...
                                                <p class="text-center mb-0">
                                                    <span class="badge" id="preview-badge" style="background-color: <?= htmlspecialchars($grupo['color_credencial']) ?>; color: <?= $text_color ?>; border: <?= $brightness > 128 ? '1px solid #ccc' : 'none' ?>;">
                                                        <span id="preview-grado"><?= htmlspecialchars($grupo['nombre_grado']) ?></span> <span id="preview-grupo"><?= htmlspecialchars($grupo['nombre_grupo']) ?></span>
                                                        <span id="preview-turno" class="ms-1"><?= htmlspecialchars($grupo['nombre_turno']) ?></span>
                                                    </span>
                                                </p>
                                            </div>
                                        </div>
                                ...
                                <div class="alert alert-warning">
                                    ...
                                    <strong>Nota:</strong> Cambiar el grupo puede afectar a los alumnos ya asignados a este grupo.
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        ...
                        <a href="ver.php?id=<?= $id_grupo ?>" class="btn btn-secondary btn-lg">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        gradoSelect.addEventListener('change', function() {
            ...
            previewGrado.textContent = selectedOption.text;
        });
